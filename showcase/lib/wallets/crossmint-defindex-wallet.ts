// Copied verbatim from src/wallets/crossmint-defindex-wallet.ts for the self-contained Phase 2 showcase.
// Source of truth lives in src/wallets/crossmint-defindex-wallet.ts — keep in sync if that changes.
