// Copied verbatim from src/shared/crossmint-rest.ts for the self-contained Phase 2 showcase.
// Source of truth lives in src/shared/crossmint-rest.ts — keep in sync if that changes.
