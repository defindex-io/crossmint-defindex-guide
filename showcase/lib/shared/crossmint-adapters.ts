// Copied verbatim from src/shared/crossmint-adapters.ts for the self-contained Phase 2 showcase.
// Source of truth lives in src/shared/crossmint-adapters.ts — keep in sync if that changes.
import {
  IEvmWalletProvider,
  EvmRawTransaction,
