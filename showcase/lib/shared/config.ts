// Copied verbatim from src/shared/config.ts for the self-contained Phase 2 showcase.
// Source of truth lives in src/shared/config.ts — keep in sync if that changes.
