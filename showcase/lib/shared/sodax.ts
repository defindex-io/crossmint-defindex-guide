// Copied verbatim from src/shared/sodax.ts for the self-contained Phase 2 showcase.
// Source of truth lives in src/shared/sodax.ts — keep in sync if that changes.
import {
  Sodax,
